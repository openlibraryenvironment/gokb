...
export MAPPING_FILE=$SCRIPT_DIR"/../server/gokbg3/grails-app/conf/elasticsearch/es_mapping.json"
export SETTINGS_FILE=$SCRIPT_DIR"/../server/gokbg3/grails-app/conf/elasticsearch/es_settings.json"

...
export MAPPING_FILE=$SCRIPT_DIR"/../server/grails-app/conf/elasticsearch/es_mapping.json"
export SETTINGS_FILE=$SCRIPT_DIR"/../server/grails-app/conf/elasticsearch/es_settings.json"

...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
  ...
  <g:each in="${d.decisionSupportLines?.values()}" var="dsl">
    ...
    <div class="panel panel-default">
      ...
      <div id="collapse${dsl.id}" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="${dsl.id}">
        <div class="panel-body">

          <div class="container">
            <div class="row">
              <div class="col-md-4">Criteria</div> <div class="col-md-8">Notes</div>
            </div>

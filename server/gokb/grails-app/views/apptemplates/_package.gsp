<g:set var="editable" value="${ d.isEditable() && ((request.curator != null ? request.curator.size() > 0 : true) || (params.curationOverride == "true")) }" />
  <dl class="dl-horizontal">
    ...
    <ul id="tabs" class="nav nav-tabs">
      ...
      <li><a href="#titledetails" data-toggle="tab">Titles/TIPPs <span class="badge badge-warning"> ${d.titles?.size() ?: '0'}/${d.tipps?.findAll{ it.status.value == 'Current'}?.size() ?: '0'} </span></a></li>

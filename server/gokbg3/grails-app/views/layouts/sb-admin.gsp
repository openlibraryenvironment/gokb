                ...
                <li class="${params?.controller == "admin" ? 'active' : ''}"><a href="#"><i class="fa fa-wrench fa-fw"></i> Admin<span class="fa arrow"></span></a>
                  <ul class="nav nav-second-level">
                    ...
                    <sec:ifAnyGranted roles="ROLE_SUPERUSER">
                      ...
                      <li><g:link controller="admin" action="updateTextIndexes" onclick="return confirm('This triggers the ES Update based on the current FTControl timestamps! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Update Free Text Indexes</g:link></li>
                      <li><g:link controller="admin" action="resetTextIndexes" onclick="return confirm('This deletes the saved timestamps of the last ES Update in FTControl! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Reset Free Text Indexes</g:link></li>
                      ...
                      <li><g:link controller="admin" action="convertTippCoverages" onclick="return confirm('Missing TIPPCoverageStatements will be created for ALL TIPPs with coverage information! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Convert old coverage statements</g:link></li>
                      <li><g:link controller="admin" action="cleanup" onclick="return confirm('ALL KBComponents with the status -Deleted- will be expunged from the database! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Expunge Deleted Records</g:link></li>
                      <li><g:link controller="admin" action="cleanupPlatforms" onclick="return confirm('The status of ALL Platforms without a unique name and no primaryUrl will be set to -Deleted-! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Deprecate Platforms Without URLs</g:link></li>
                      <li><g:link controller="admin" action="markInconsistentDates" onclick="return confirm('New ReviewRequests will be generated for each erroneous  TIPPs, TitleInstances and TIPPCoverageStatements will be inspected for Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Add Reviews for wrong Dates</g:link></li>
                      <li><g:link controller="admin" action="cleanupRejected" onclick="return confirm('ALL KBComponents with the editStatus -Rejected- will be expunged from the database! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Expunge Rejected Records</g:link></li><li><g:link controller="admin" action="cleanupOrphanedTipps" onclick="return confirm('ALL TIPPs whose titles have been expunged from the system will be deleted! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Expunge Orphaned TIPPs</g:link></li>
                      <li><g:link controller="admin" action="ensureUuids" onclick="return confirm('ALL KBComponents will be inspected and missing UUIDs generated! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Ensure UUIDs</g:link></li>
                      <li><g:link controller="admin" action="ensureTipls" onclick="return confirm('ALL TIPPs will be inspected and missing TIPLs generated! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Ensure TIPLs</g:link></li>
                      ...
                      <li><g:link controller="admin" action="rejectWrongTitles" onclick="return confirm('This will set the status of ALL titles without package links AND no history events to -Deleted-! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Delete Titles w/o Package & History</g:link></li>
                      <li><g:link controller="admin" action="rejectNoIdTitles" onclick="return confirm('This will set the status of ALL titles without Identifiers and TIPPs to -Deleted-! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Delete Titles w/o Identifiers & Package</g:link></li>
                      <li><g:link controller="admin" action="setupAcl" onclick="return confirm('This adds the default permissions for all user groups. It will not revoke existing permissions! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Setup ACL defaults</g:link></li>
                      <li><g:link controller="admin" action="addPackageTypes" onclick="return confirm('This will generate a value in contentType for ALL Packages based on their contents! Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Generate Package Types</g:link></li>

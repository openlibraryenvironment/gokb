          ...
          <li class="${params?.controller == "admin" ? 'active' : ''}"><a href="#"><i class="fa fa-wrench fa-fw"></i> Admin<span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
              ...
              <%-- <li><g:link controller="admin" action="tidyOrgData" onclick="return confirm('Are you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Tidy Orgs Data</g:link></li> --%>
                ...
                <li><g:link controller="admin" action="cleanupRejected" onclick="return confirm('This will completely erase ALL components (titles, ids, packages, tipps, curatory groups etc.) that have an editStatus of -Rejected- as well as the status -Deleted- from the database! \\n\\nAre you sure?')"><i class="fa fa-angle-double-right fa-fw"></i> Expunge Rejected Records</g:link></li>

...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
  ...
  [pattern: '/greenmail/**',                  access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/greenmail',                     access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  ...
  [pattern: '/component/identifierConflicts', access: ["hasAnyRole('ROLE_ADMIN', 'ROLE_POWERUSER') and isFullyAuthenticated()"]],
  [pattern: '/public',                        access: ['permitAll']],
  [pattern: '/error',                         access: ['permitAll']],
  [pattern: '/error/**',                      access: ['permitAll']],
  [pattern: '/globalSearch/**',               access: ["hasAnyRole('ROLE_ADMIN', 'ROLE_POWERUSER') and isFullyAuthenticated()"]],
  [pattern: '/home/**',                       access: ["hasAnyRole('ROLE_ADMIN', 'ROLE_POWERUSER') and isFullyAuthenticated()"]],
  ...
  [pattern: '/api/userData',                  access: ["isFullyAuthenticated()"]],
  [pattern: '/api/refdata',                   access: ["hasRole('ROLE_USER')"]],
  [pattern: '/api/show',                      access: ["hasRole('ROLE_USER')"]],
  [pattern: '/api/namespaces',                access: ['permitAll']],
  [pattern: '/api/groups',                    access: ['permitAll']],
  [pattern: '/api/elasticsearchTunnel',       access: ["hasRole('ROLE_ADMIN') and isFullyAuthenticated()"]],
  [pattern: '/api/retrieveZdbCandidates',     access: ["hasRole('ROLE_USER')"]],
  [pattern: '/integration/**',                access: ["hasRole('ROLE_API')"]],
  [pattern: '/fwk/**',                        access: ["hasAnyRole('ROLE_ADMIN', 'ROLE_POWERUSER')"]],
  [pattern: '/user/search',                   access: ["hasRole('ROLE_ADMIN') and isFullyAuthenticated()"]],
  [pattern: '/user/edit/**',                  access: ["hasRole('ROLE_ADMIN') and isFullyAuthenticated()"]],
  [pattern: '/user/**',                       access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/role/**',                       access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/securityInfo/**',               access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/registrationCode/**',           access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/aclClass/**',                   access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/aclSid/**',                     access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/aclObjectIdentity/**',          access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/aclEntry/**',                   access: ["hasRole('ROLE_SUPERUSER') and isFullyAuthenticated()"]],
  [pattern: '/oai',                           access: ['permitAll']],
  [pattern: '/oai/**',                        access: ['permitAll']],
  [pattern: '/rest/login',                    access: ['permitAll']],
  [pattern: '/rest/refdata',                  access: ['permitAll']],
  [pattern: '/rest/refdata/**',               access: ['permitAll']],
  [pattern: '/rest/**',                       access: ["hasRole('ROLE_USER') and isFullyAuthenticated()"]],
  [pattern: '/oauth/**',                      access: ['permitAll']],
  [pattern: '/coreference/**',                access: ["hasAnyRole('ROLE_ADMIN', 'ROLE_POWERUSER') and isFullyAuthenticated()"]],

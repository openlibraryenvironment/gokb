...
class DateFormatService {
  ...
  static String formatDenseTimestamp(Date date) {
    TIMESTAMP_DENSE_FORMAT.format(date)
  }

  static String parseDenseTimestamp(String date) {
    TIMESTAMP_DENSE_FORMAT.parse(date)
  }
}

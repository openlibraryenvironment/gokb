...
class SecurityApi <T> extends A_Api<T> {
  ...
  public static boolean isTypeEditable (Class clazz, boolean defaultTo = true) {
    hasPermission (clazz, org.springframework.security.acls.domain.BasePermission.WRITE)
  }

  public static boolean isTypeCreatable (Class clazz, boolean defaultTo = true) {
    hasPermission (clazz, org.springframework.security.acls.domain.BasePermission.CREATE)
  }

  public static boolean isTypeReadable (Class clazz, boolean defaultTo = true) {
    hasPermission (clazz, org.springframework.security.acls.domain.BasePermission.READ)
  }

  public static boolean isTypeDeletable (Class clazz, boolean defaultTo = true) {
    hasPermission (clazz, org.springframework.security.acls.domain.BasePermission.DELETE)
  }

  public static boolean isTypeAdministerable (Class clazz, boolean defaultTo = true) {
  ...
  public static boolean hasPermission(Class clazz, Permission p, boolean defaultTo = true) {
